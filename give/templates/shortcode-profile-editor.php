...
if ( is_user_logged_in() ) :
	...
	<form id="give_profile_editor_form" class="give-form" action="" method="post">
		<fieldset>
			...
			<div id="give_profile_password_wrap" class="give-clearfix">
				...
				<p id="give_profile_password_wrap_1" class="form-row form-row-first form-row-responsive">
					<label for="line1"><?php _e( 'Address 1', 'give' ); ?></label>
					<input name="_give_donor_address_billing_line1_0" id="line1" class="password give-input"
						   type="text" value="<?php echo esc_attr( $address['line1'] ); ?>" />
				</p>

				<p id="give_profile_password_wrap_2" class="form-row form-row-last form-row-responsive">
					<label for="line2"><?php _e( 'Address 2', 'give' ); ?></label>
					<input name="_give_donor_address_billing_line2_0" id="line2" class="give-input"
			...
			<div id="give_profile_password_wrap" class="give-clearfix">
				...
				<p id="give_profile_password_wrap_1" class="form-row form-row-first form-row-responsive">
					<label for="give_new_user_pass2"><?php _e( 'Country', 'give' ); ?></label>

					<select name="_give_donor_address_billing_country_0" id="country-select" class="select give-select">
						
						<!-- <option <?php selected( $address['country'], $address['country'] ); ?>
							value="<?php echo esc_attr( $address['country'] ); ?>"><?php echo esc_html( $address['country'] ); ?></option> -->
						
					</select>
				</p>

				<p id="give_profile_password_wrap_2" class="form-row form-row-last form-row-responsive">
					<label for="give_new_user_pass2"><?php _e( 'Province', 'give' ); ?></label>
					
					<select class="give-input password select give-select" name="_give_donor_address_billing_state_0" id="state-select" disabled="">
			...
			<div id="give_profile_password_wrap" class="give-clearfix">
				...
				<p id="give_profile_password_wrap_1" class="form-row form-row-first form-row-responsive">
					<label for="give_new_user_pass1"><?php _e( 'City', 'give' ); ?></label>
					<input name="_give_donor_address_billing_city_0" id="city" class="give-input"
						   type="text" value="<?php echo esc_attr( $address['city'] ); ?>"/>
				</p>

				<p id="give_profile_password_wrap_2" class="form-row form-row-last form-row-responsive">
					<label for="give_new_user_pass1"><?php _e( 'Postal Code', 'give' ); ?></label>
					<input name="_give_donor_address_billing_zip_0" id="give_zip" class="give-input"
	...
	<script type="text/javascript">
		...
		var countryStates = {
		  ...
		  jQuery.each(countryStates, function(country, states) {
		  ...
		  countrySelect.change(function() {
		    ...
		    var stateSelect = jQuery('#state-select');
		    
		    // Clear and disable the state select
		    stateSelect.empty().prop('disabled', true);
		    
		    // Populate the state select options if a country is selected
		    if (selectedCountry) {
