...
.success:hover {background-color: smokewhite;}
</style>

<div class="projects_row">
  <div class="projects_column" style="background-color:#9A90D4;">
    <h2>International Projects</h2>
    <p>Support our disaster relief and sustainable international projects.</p>
	<a href="#" class="btn success">Donate</a>
  </div>
  <div class="projects_column" style="background-color:#04A9F5;">
    <h2>Domestic Projects</h2>
    <p>Support our various sustainable domestic projects in Canada.</p>
	<a href="#" class="btn success">Donate</a>
  </div>
  <div class="projects_column" style="background-color:#1DC7E4;">
    <h2>Orphan Sponsorship Program</h2>
    <p>Sponsor orphans from a variety of countries starting at $30/month.</p>
	<a href="#" class="btn success">Donate</a>
  </div> 
</div>
<div class="projects_row">
  <div class="projects_column" style="background-color:#9A90D4;">
    <h2>Sadaqa / Aqeeqah</h2>
    <p>Perform Sadaqah or Aqeeqah and distribute meat to deserving people.</p>
	<a href="#" class="btn success">Donate</a>
  </div>
  <div class="projects_column" style="background-color:#04A9F5;">
    <h2>Fitra / Fidya / Kaffara</h2>
    <p>Mandatory fitra during the month of Ramadan. Starting at $10/person.</p>
	<a href="#" class="btn success">Donate</a>
  </div>
  <div class="projects_column" style="background-color:#1DC7E4;">
    <h2>Zabiha / Qurbani / Udhya</h2>
    <p>Zabiha / Qurbani / Udhya</p>
	<a href="#" class="btn success">Donate</a>
  </div> 
</div>
	<h2>this is test</h2>
